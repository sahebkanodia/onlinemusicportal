...
<body>
    ...
    if(adminId!=null)
        ...
        %>
 <form name="form2" method="post" action="alogout.jsp">
    ...
    <div id="templatemo_right_column">
            <div class="templatemo_right_panel_fullwidth">
             ...
             <div class="templatemo_right_panel_fullwidth_content">
                  ...
                  <!-- Code Here -->  
                    <div align="center"><input name="toIndex" type="button" value="Back to Homepage" onClick="window.location='admin.html'"></div>
