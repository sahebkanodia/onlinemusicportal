...
<body>
 ...
 if(rs.next())
     {
   %>
<form name="form2" method="post" action="adminprofile.jsp">
    ...
    <div id="templatemo_right_column">
        	<div id="new_released_section">
                ...
                <p>
                    ...
                    <td align="left"> <%=rs.getString(3)%></td></tr>
                <p>
                <tr><td align="left">Address :</td>
                <td align="left"><%=rs.getString(4)%></td></tr>
                <p>
                <tr><td align="left">E-mail :</td>
                <td align="left"><%=rs.getString(5)%></td></tr>
                <p>
                <tr><td align="left">Contact Number :</td>
                <td align="left"><%=rs.getString(6)%></td></tr>
                <p>
                <tr><td align="left">Gender :</td>
                <td align="left"><%=rs.getString(7)%></td></tr>
                <p>
                    </table>
                <p><p><p>
                   <div align="center"><input name="home" type="button" value="Back to Home" onClick="window.location='adminhome.jsp'"></div>  <p><p><p><p><p><p>
                </div></div>
    </div></div>
